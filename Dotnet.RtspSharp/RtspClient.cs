...
namespace Dotnet.RtspSharp
{
    public sealed class RtspClient : IRtspClient
    {
        ...
        public object LogManagerAsync { get; private set; }
        ...
        public async Task ConnectAsync(CancellationToken token)
        {
            await Task.Run(async () =>
            {
                ...
                try
                {
                    LogMangerNative.Instance.Info("Connection Try....");
                    Task connectionTask = _rtspClientInternal.ConnectAsync(token);

                    if (connectionTask.IsCompleted)
                    {
                        LogMangerNative.Instance.Info("Connection Completed....");
                ...
                catch (Exception e)
                {
                    ...
                    if (e is RtspBadResponseCodeException rtspBadResponseCodeException &&
                        ...
                        throw new InvalidCredentialException($"Invalid login and/or password : {e.Message}");
