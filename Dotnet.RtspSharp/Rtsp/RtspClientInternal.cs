...
using Dotnet.RtspSharp.Codecs.Video;
using Dotnet.RtspSharp.MediaParsers;
using Dotnet.RtspSharp.RawFrames;
using Dotnet.RtspSharp.Rtcp;
using Dotnet.RtspSharp.Rtp;
using Dotnet.RtspSharp.Sdp;
using Dotnet.RtspSharp.Tpkt;
...
namespace Dotnet.RtspSharp.Rtsp
{
    sealed class RtspClientInternal : IDisposable
    {
        ...
        public async Task ConnectAsync(CancellationToken token)
        {
            ...
            LogMangerNative.Instance.Info("_rtspTransportClient Connection Try....");
            ...
            LogMangerNative.Instance.Info($"_rtspTransportClient Response {optionsResponse.StatusCode.ToString()}");
            ...
            {
                LogMangerNative.Instance.Info($"_rtspTransportClient Response Body {item.TrackName}");
            }
            ...
            LogMangerNative.Instance.Info($"_rtspTransportClient CreatePlayRequest...");
